...
// Loop through the picArray and create articles dynamically
for (const pic of picArray) {
  // Create the article element
  const article = document.createElement('article');

  // Create and append the h2 element for the title
  ...
  img.src = pic.image.medium; // Use the medium image
  img.alt = pic.title; // Alt text is the title
